...
for (i in 1:nf) {
   ...
   garchx.vix=ugarchspec(variance.model=list(model="sGARCH",garchOrder=c(1,1),external.regressors=x2),mean.model=list(armaOrder=c(0,0),include.mean=T),distribution.model="std")
    # estimation for i'th window
